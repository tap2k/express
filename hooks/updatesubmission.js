...
export default async function updateSubmission( {myFormData, contentID, order, title, description, name, email, location, lat, long, ext_url, published, deletePic, textAlignment} ) 
{  
  if (!contentID)
  {
